package com.jsoft.edums.common.plugin;
...
import com.jsoft.edums.common.util.ReflectHelper;
		...
		if(ivk.getTarget() instanceof RoutingStatementHandler){
			...
			/*	if(parameterObject instanceof HashMap){
				...
				if(parameterObject==null){
					...
					Page page = null;
					if(parameterObject instanceof HashMap){  //如果传入的是一个map
						page = (Page)((HashMap<String, Object>)parameterObject).get("page");
						if(page!=null){
							page.setEntityOrField(true);	 //见com.flf.entity.Page.entityOrField 注释
							page.setTotalResult(count);	
							((HashMap<String, Object>)parameterObject).put("page", page);
						}
					}else{
