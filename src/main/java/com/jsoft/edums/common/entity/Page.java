...
public class Page {
	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			sb.append("		var url = document.forms[0].getAttribute(\"action\");console.log(url);\n");
			sb.append("		if(url.indexOf('?')>-1){url += \"&"+(entityOrField?"currentPage":"page.currentPage")+"=\";}\n");
			sb.append("		else{url += \"?"+(entityOrField?"currentPage":"page.currentPage")+"=\";}\n");
			sb.append("		document.forms[0].action = url+page;console.log(url+page);console.log(document.forms[0].action);\n");
			...
			sb.append("			}\n");
			sb.append("		}else{url += \"?"+(entityOrField?"currentPage":"page.currentPage")+"=\";}\n");
			sb.append("		document.location = url + page;console.log(url+page)\n");
			sb.append("	}\n");
			sb.append("}\n");
			sb.append("</script>\n");
		}
