...
<link rel="stylesheet" type="text/css"
	...
	function check(){
		...
		if(v==""){
			document.getElementById("err").innerHTML="字典名称不能为空！ ";
...
<body>
<form action="save.html" method="post" class="definewidth m20">
<table class="table table-bordered table-hover m10">

    <tr >
        <td width="15%"  class="tableleft">上级字典</td>
        <td>
        
            <select name="fatherId">
            <option >请选择</option>
            <option value="a">空</option>
            <c:forEach var="pm" items="${dictionList }">
           <option value="${pm.childId }">${pm.dictionName }</option>  
           </c:forEach>
           </select>
        </td>
    </tr>
    <tr>
        <td class="tableleft">字典名称</td>
        <td><input type="text" name="dictionName" id="name"/><span id="err" style="color:red;"></span></td>
    </tr>
    <tr>
        <td class="tableleft">备注</td>
        <td><input type="text" name="describle"/></td>
    </tr>
